...
<div class="panel panel-warning">
  ...
  {{ Form::model($statement, array('method' => 'PATCH', 'route' => array('statements.update', $statement->id))) }}
    <div class="form-group">
      ...
      {{Form::textarea('statement_one', Input::old('statement_one'), ['class' => 'form-control'])}}
      </div>
    <div class="form-group">
      ...
      {{Form::textarea('statement_two', Input::old('statement_two'), ['class' => 'form-control'])}}
    </div>
    <div class="form-group">
      <label>Can you describe briefly any ambitions you have to pursue further academic studies? (100 Words)</label>
      {{Form::textarea('statement_three', Input::old('statement_three'), ['class' => 'form-control'])}}
    </div>
  </div>
