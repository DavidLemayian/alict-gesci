  ...
  <div class="panel-body">
    {{ Form::open(array('route' => 'languages.store')) }}
      <div class="form-group">
        ...
        {{Form::select('spoken_english', Language::$spoken_english, Input::old('spoken_english'), ['class' => 'form-control'])}}
      </div>
      <div class="form-group">
        <label for="written_english">Written English</label>
        {{Form::select('written_english', Language::$written_english, Input::old('written_english'), ['class' => 'form-control'])}}
      </div>
  </div>
